...
// configuration step. It creates a namespace called `cppbp_gamejam`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        cppbp_gamejam::cmake::project_name,
        cppbp_gamejam::cmake::project_version));// version string, acquired
